...
draw_ellipse(ax, P1, C_ISO, edgecolor=COL_P1, lw=0.9, alpha=FADE)
draw_point(ax, P1, color=COL_P1, marker="o", alpha=FADE)
draw_point(ax, O_BAD, color=COL_OB, marker="^")
...
draw_principal_axes(ax, O_GOOD, C_NEW, color=COL_NEW_ELLIPSE, lw=1.2)
