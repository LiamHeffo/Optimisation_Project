...
for P in (P1, P2):
    draw_ellipse(ax, P, C_ISO, edgecolor=COL_IND, lw=0.9, alpha=FADE)
    draw_point(ax, P, color=COL_IND, marker="o", alpha=FADE)
draw_point(ax, O3, color=COL_OB, marker="^")
...
for centre, C_new, label, dx, dy in [
    ...
    draw_principal_axes(ax, centre, C_new, color=COL_IND, lw=1.2)
